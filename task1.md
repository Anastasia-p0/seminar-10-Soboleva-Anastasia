...
7. Выполните запрос для поиска книги 'Oracle Core' и получите план выполнения:
   ...
   *Объясните результат:*
   Время выполнения сильно сократилось по стравнению с ситуацией, когда не были использованы индексы.
...
10. Выполните запрос для поиска активных книг и получите план выполнения:
   ```sql
   EXPLAIN ANALYZE
